    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12 open-hour-wrap">
                ...
                <h5 class="text-left text-primary font-weight-bold">Quand consulter le dentiste? </h5>
            ...
            <div class="container">
                <div class="mb-3">
                    <h5 class="text-left text-primary">Les principales étapes courantes d'une
                        consulation de routine</h5>
                    <br>
                    <p class="text-justify pb-3">
                        Nettoyage et détartrage : les consultations chez le dentiste pour un contrôle annuel commencent
                        souvent par un nettoyage en profondeur de vos dents. En effet, une fois que la plaque dentaire
                        s’est
                        minéralisée et qu’elle s’est transformée en tartre, seul un dentiste peut l’éliminer en
                        réalisant un
                        détartrage, étape souvent non-douloureuse. Ce détartrage est essentiel pour éviter la
                        prolifération
                    ...
                    <p class="text-justify pb-3">
                        ...
                        problèmes de gencives, pour les soigner le plus tôt possible et éviter des problèmes plus
                        sérieux.
                    ...
                    <p class="text-justify pb-3">
                        ...
                        interdentaire pourront être détectées grâce à une radio lors d’une simple visite chez le
                        dentiste.
                    </p>
                </div>
            </div>
